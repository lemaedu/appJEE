...
COMMENT ON COLUMN "tb_ubicacion_menu"."status" IS 'estado (true=activo,false=inactivo)';
...
COMMENT ON COLUMN "tb_usuario"."status" IS 'estado (true=activo,false=inactivo)';
...
WITHOUT OIDS;
COMMENT ON COLUMN "tb_usuario_rol"."status" IS 'estado (true=activo,false=inactivo)';
